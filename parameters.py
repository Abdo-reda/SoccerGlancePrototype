...
def getParameters():
    ...
    parser.add_argument('--features_type', type=str,
                        default="ResNET", help="ResNET or R25D [default:ResNET]")
    ...
    parser.add_argument('--GPU', required=False, type=int,
                        default=0, help='ID of the GPU to use')
    ...
    parser.add_argument('--path_video', type=str,
                        required=True, help="Path of the Input Video")
    parser.add_argument('--path_output', type=str,
                        required=True, help="Path of the Output Features")
    ...
    parser.add_argument('--video_res', type=str,
                        default="LQ", help="LQ or HQ? [default:LQ]")
    ...
    parser.add_argument('--LRe', required=False, type=float,
                        default=1e-06, help='Learning Rate end')
    ...
    parser.add_argument('--pool', required=False, type=str,
                        default="NetVLAD++", help='How to pool')
